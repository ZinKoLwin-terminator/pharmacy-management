        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{url('admin/purchases/edit/'.$oldRecord->id)}}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="suppliers_id" class="form-control" required>
                                    ...
                                    <option {{($supplier->id==$oldRecord->suppliers_id)?'selected':''}} value="{{$supplier->id}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="voucher_number" class="form-control" value="{{$oldRecord->voucher_number}}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" name="purchase_date" class="form-control" value="{{$oldRecord->purchase_date}}"  required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="payment_status" class="form-control" required>
                                    ...
                                    <option {{($oldRecord->payment_status==1)?'selected':''}} value="1">
                                        Pending
                                     </option>

                                     <option {{($oldRecord->payment_status==2)?'selected':''}} value="2">
                                        Accept
                                    </option>

                                    <option {{($oldRecord->payment_status==3)?'selected':''}} value="3">
                                        Cancel
                                    </option>
                                </select>
